 ...
 * Details
 */
public class UTEServices extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ute_services);

        AsyncHttpClient client = new AsyncHttpClient();
        client.get("https://api.myjson.com/bins/47dq6", new AsyncHttpResponseHandler() {
            @Override
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                ArrayList<String> status = getStatus(response, "time", "guest", "login", "res", "weather", "flight", "location", "customer", "mobile", "resSeats", "resBag");
                ...
                if(status.get(1).equalsIgnoreCase("pass")) {
                    r1.setBackgroundColor(ContextCompat.getColor(getBaseContext(), R.color.success));
                    r1.setTextColor(ContextCompat.getColor(getBaseContext(), R.color.white));
                }
                else {
                    r1.setBackgroundColor(ContextCompat.getColor(getBaseContext(), R.color.failure));
                    r1.setTextColor(ContextCompat.getColor(getBaseContext(), R.color.white));
                }
                ...
                if(status.get(9).equalsIgnoreCase("pass")) {
                ...
                if(status.get(10).equalsIgnoreCase("pass")) {
